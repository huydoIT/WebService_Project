...
namespace SERVICE
{
    ...
    public class SanPham_Service : System.Web.Services.WebService
    {
        ...
        [WebMethod]
        public bool Update_SanPham(int ma_sp, string ten_sp, string mota, string gia, string hinh, string phanloai)
        {
            try
            {
        ...
        [WebMethod]
        public bool Insert_SanPham(string ten_sp, string mota, string gia, string hinh, string phanloai)
        {
            try
            {
